...
install: install-packages install-wrapper install-fish install-foot install-starship install-qutebrowser install-bash install-nvim install-tmux install-scripts
